...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('characters_character', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Character.gm_notes'
        db.alter_column('characters_character', 'gm_notes', self.gf('mcnulty.dashboard.fields.HtmlField')(null=True))


    def backwards(self, orm):

        # Deleting field 'Character.avatar'
        db.delete_column('characters_character', 'avatar')

        # Changing field 'Character.gm_notes'
        db.alter_column('characters_character', 'gm_notes', self.gf('django.db.models.fields.TextField')(null=True))
